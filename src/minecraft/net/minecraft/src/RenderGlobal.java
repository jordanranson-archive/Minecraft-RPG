        ...
        if (this.mc != null && this.mc.renderViewEntity != null && this.mc.effectRenderer != null)
        {
            ...
            else
            {
                ...
                else
                {
					...
					// Minecraft RPG
					else if (par1Str.equals("glowflower"))
                    {
                        var21 = new EntityGlowflowerFX(this.theWorld, par2, par4, par6, (float)par8, (float)par10, (float)par12);
                    }
                    else if (par1Str.equals("frozenenchant"))
                    {
                        var21 = new EntityFrozenFX(this.theWorld, par2, par4, par6, (float)par8, (float)par10, (float)par12);
                    }
					...
					else if (par1Str.equals("slag"))
                    {
                        var21 = new EntityBreakingFX(this.theWorld, par2, par4, par6, Item.blazePowder);
                    }
                    ...
                    else if (par1Str.equals("lifesteal"))
                    {
                        var21 = new EntityLifeStealFX(this.theWorld, par2, par4, par6, (float)par8, (float)par10, (float)par12);
                    }
					else if (par1Str.equals("flee"))
                    {
        ...
        switch (par2)
        {
			...
			case 9999:
				...
				switch(par6)
				{
					case 1: // flame
						var14 = "slag";
						particle = "flameenchant";
						break;
					case 2: // freeze
						var14 = "snowballpoof";
						particle = "frozenenchant";
						break;
					case 3: // life steal
						var14 = null;
						particle = "lifesteal";
				...
				for (var20 = 0; var20 < 54; ++var20)
				{
					var39 = var7.nextDouble() * 2.0D;
					var23 = var7.nextDouble() * Math.PI * 2.0D;
					var25 = Math.cos(var23) * var39;
					var27 = 0.01D + (var7.nextDouble() * 0.35D);
					
					var29 = Math.sin(var23) * var39;
					EntityFX var31 = this.func_72726_b(particle, var8 + var25 * 0.35D, var10 + (-0.3D + (var7.nextDouble() * 0.65D)), var12 + var29 * 0.35D, var25, var27, var29);
					if (var31 != null)
					{
						var31.multiplyVelocity(-((float)var39 / 2));
					}
				}

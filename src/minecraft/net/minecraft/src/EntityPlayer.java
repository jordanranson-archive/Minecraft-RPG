        ...
        if (par1Entity.canAttackWithItem())
        {
            ...
            if (var2 > 0 || var4 > 0)
            {
                ...
                if (par1Entity instanceof EntityLiving)
                {
					...
					int var9 = EnchantmentHelper.getFrozenWeaponModifier(this.inventory, (EntityLiving)par1Entity);
					if(var9 > 0)
					{
					...
					int flameMod = EnchantmentHelper.getFireAspectModifier(this.inventory, (EntityLiving)par1Entity);
					int freezeMod = EnchantmentHelper.getFrozenWeaponModifier(this.inventory, (EntityLiving)par1Entity);
					int lifestealMod = EnchantmentHelper.getLifestealWeaponModifier(this.inventory, (EntityLiving)par1Entity);
					int fleeMod = EnchantmentHelper.getFleeWeaponModifier(this.inventory, (EntityLiving)par1Entity);
					int magicEffectId = 0;
					
					// Flame
					if (flameMod > 0)
					{
						par1Entity.setFire(4 * flameMod);
						magicEffectId = 1;
					}
					// Freeze
					else if (freezeMod > 0)
					{
						EntityLiving entityHit = (EntityLiving)par1Entity;
						entityHit.addPotionEffect(new PotionEffect(2, 71 * freezeMod, 0));
						magicEffectId = 2;
					}
					// Life steal
					else if (lifestealMod > 0)
					{
						int result;
					...
					{
						EntityLiving entityHit = (EntityLiving)par1Entity;
						entityHit.addPotionEffect(new PotionEffect(31, 41 * (fleeMod / 2), 0));
						magicEffectId = 4;
					}
					...
					{
						EntityLiving entityHit = (EntityLiving)par1Entity;
						this.worldObj.playAuxSFX(9999, (int)Math.round(entityHit.posX), (int)Math.round(entityHit.posY + 1.0F), (int)Math.round(entityHit.posZ), magicEffectId);

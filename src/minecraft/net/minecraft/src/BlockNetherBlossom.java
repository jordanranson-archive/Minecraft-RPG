...
public class BlockNetherBlossom extends BlockFlower
{
    protected BlockNetherBlossom(int par1, int par2)
    {
        super(par1, par2);
    ...
    private float getGrowthRate(World par1World, int par2, int par3, int par4)
    {
        ...
        for (int var17 = par2 - 1; var17 <= par2 + 1; ++var17)
        {
            for (int var18 = par4 - 1; var18 <= par4 + 1; ++var18)
            {
                ...
                if (var19 == Block.dirt.blockID || var19 == Block.grass.blockID || var19 == Block.tilledField.blockID)
                {
                    var20 = 1.0F;
        ...
        if (!par1World.isRemote)
        {
            ...
            for (int var9 = 0; var9 < var8; ++var9)
            {
                if (par1World.rand.nextInt(15) <= par5)
                {
                    ...
                    EntityItem var14 = new EntityItem(par1World, (double)((float)par2 + var11), (double)((float)par3 + var12), (double)((float)par4 + var13), new ItemStack(Item.plantPurplePod));
    ...
    {
        return par1 == 3 ? Item.powderFragrant.shiftedIndex : -1;
    }
    ...
    {
        return Item.plantPurplePod.shiftedIndex;
    }
}

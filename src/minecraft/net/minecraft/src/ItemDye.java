        ...
        else
        {
            ...
            if (par1ItemStack.getItemDamage() == 15)
            {
				...
				if (var11 == Block.plantGlow.blockID)
                {
                    if (!par3World.isRemote)
                    {
                        ((BlockGlowFlower)Block.plantGlow).fertilize(par3World, par4, par5, par6, par3World.rand);
                        --par1ItemStack.stackSize;
                    }
				...
				if (var11 == Block.plantGlowSpore.blockID)
                {
                    if (!par3World.isRemote)
                    {
                        ((BlockGlowFlowerSpore)Block.plantGlowSpore).fertilize(par3World, par4, par5, par6, par3World.rand);
                        --par1ItemStack.stackSize;
                    }
				...
				if (var11 == Block.plantPurple.blockID)
                {
                    ...
                    if (!par3World.isRemote)
                    {
                        ((BlockNetherBlossom)Block.plantPurple).fertilize(par3World, par4, par5, par6);
                        --par1ItemStack.stackSize;
                    }

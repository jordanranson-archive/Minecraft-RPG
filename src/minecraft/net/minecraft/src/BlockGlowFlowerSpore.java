...
public class BlockGlowFlowerSpore extends Block
{
    protected BlockGlowFlowerSpore(int par1, int par2, Material par3Material)
    {
    ...
    protected BlockGlowFlowerSpore(int par1, int par2)
    {
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
		...
		/*if (par5Random.nextInt(39) == 0)
		{
			par1World.setBlockWithNotify(par2, par3, par4, this.blockID + 1);
		}*/
    }
    ...
    {
        return Item.powderSparkling.shiftedIndex;
    }

...
public class BiomeDecorator
{
    ...
    public BiomeDecorator(BiomeGenBase par1BiomeGenBase)
    {
        ...
        this.plantRedGen = new WorldGenFlowersNoise(Block.plantRed.blockID, Block.plantPurple.blockID);
        this.plantGlowGen = new WorldGenFlowersSparse(Block.plantGlow.blockID);
    ...
    protected void decorate()
    {
        ...
        for (var2 = 0; var2 < this.flowersPerChunk; ++var2)
        {
			...
			int next = this.randomGenerator.nextInt(4);
            if (next == 0)
            {
                var3 = this.chunk_X + this.randomGenerator.nextInt(16) + 8;
                var4 = this.randomGenerator.nextInt(128);
			...
			else if (next == 1)
            {
                ...
                var4 = this.randomGenerator.nextInt(128);
                var7 = this.chunk_Z + this.randomGenerator.nextInt(16) + 8;
				this.plantGlowGen.generate(this.currentWorld, this.randomGenerator, var3, var4, var7);
            }
        }

...
public class NetServerHandler extends NetHandler
{
    ...
    public void handleEnchantItem(Packet108EnchantItem par1Packet108EnchantItem)
    {
        ...
        {
            this.playerEntity.craftingInventory.enchantItem(this.playerEntity, par1Packet108EnchantItem.enchantment, par1Packet108EnchantItem.effectId);
            this.playerEntity.craftingInventory.updateCraftingResults();
        }
    }
	
	public void handleProspectItem(Packet133ProspectItem par1Packet108EnchantItem)
    {
        if (this.playerEntity.craftingInventory.windowId == par1Packet108EnchantItem.windowId && this.playerEntity.craftingInventory.isPlayerNotUsingContainer(this.playerEntity))
        {
            this.playerEntity.craftingInventory.prospectItem(par1Packet108EnchantItem.itemId, par1Packet108EnchantItem.quantity);
			this.playerEntity.craftingInventory.updateCraftingResults();
        }
    }

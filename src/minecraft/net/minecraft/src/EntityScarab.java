...
public class EntityScarab extends EntityMob
{
    ...
    public EntityScarab(World par1World)
    {
        super(par1World);
    ...
    protected void updateEntityActionState()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            if (this.entityToAttack == null && !this.hasPath())
            {
                ...
                if (BlockScarab.getPosingIdByMetadata(var5))
                {
    ...
    {
        return this.worldObj.getBlockId(par1, par2 - 1, par3) == Block.sand.blockID ? 10.0F : super.getBlockPathWeight(par1, par2, par3);
    }

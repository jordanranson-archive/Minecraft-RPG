...
public class EntityArrow extends Entity
{
	...
	public boolean isMagicProjectile = false;
	public int magicEffectId = -1;
        ...
        else
        {
            ...
            if (var4 != null)
            {
				if (var4.entityHit != null)
				{
					...
					{
						var4.entityHit.setFire(5 * (int)this.effectMultiplier);
					}
					...
					// Life steal
					else if (this.getMagicEffectId() == EnumMagicEffect.lifesteal.getEffectId() && var4.entityHit instanceof EntityLiving)
					{
						EntityLiving entityHit = (EntityLiving)var4.entityHit;
					...
					// Flee
					else if (this.getMagicEffectId() == EnumMagicEffect.flee.getEffectId() && var4.entityHit instanceof EntityLiving)
					{
						EntityLiving entityHit = (EntityLiving)var4.entityHit;
			...
			// Effects for arrow trails
			
            if (this.func_70241_g()) // critical strike
            {
	...
	public boolean isMagicProjectile() 
	{
		return this.isMagicProjectile;
	}
	
	public void setMagicProjectile(boolean state)
	{
		this.isMagicProjectile = state;
	}

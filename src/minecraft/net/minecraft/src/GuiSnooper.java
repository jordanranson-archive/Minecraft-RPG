...
public class GuiSnooper extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.controlList.add(this.buttonAllowSnooping = new GuiButton(1, this.width / 2 - 152, this.height - 30, 150, 20, this.field_74097_b.getKeyBinding(EnumOptions.SNOOPER_ENABLED)));
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        if (par1GuiButton.enabled)
        {
            ...
            if (par1GuiButton.id == 1)
            {
                ...
                this.buttonAllowSnooping.displayString = this.field_74097_b.getKeyBinding(EnumOptions.SNOOPER_ENABLED);
            }
        }
    }

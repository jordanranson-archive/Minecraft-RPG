...
public class Block
{
	...
	// Minecraft-RPG
	public static final BlockGlowFlower plantGlow = (BlockGlowFlower)(new BlockGlowFlower(255, 188)).setHardness(0.0F).setStepSound(soundGrassFootstep).setBlockName("glowFlower");
	public static final BlockGlowFlowerSpore plantGlowSpore = (BlockGlowFlowerSpore)(new BlockGlowFlowerSpore(254, 189)).setHardness(0.0F).setStepSound(soundGrassFootstep).setBlockName("glowFlowerSpore");
	public static final BlockNetherBlossom plantPurple = (BlockNetherBlossom)(new BlockNetherBlossom(253, 184)).setHardness(0.0F).setStepSound(soundGrassFootstep).setBlockName("purpleFlower");
	
	public static final Block blockRuby = (new BlockOreStorage(252, 190)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundMetalFootstep).setBlockName("blockRuby");

...
public class GuiEnchantment extends GuiContainer
{
    ...
    protected void mouseClicked(int par1, int par2, int par3)
    {
        ...
        for (int var6 = 0; var6 < 3; ++var6)
        {
            ...
            if (var7 >= 0 && var8 >= 0 && var7 < 108 && var8 < 19 && this.containerEnchantment.enchantItem(this.mc.thePlayer, var6, this.containerEnchantment.effectId))
            {
                this.mc.playerController.sendEnchantPacket(this.containerEnchantment.windowId, var6, this.containerEnchantment.effectId);
            }
        }
    }
        ...
        for (int var13 = 0; var13 < 3; ++var13)
        {
            ...
            else
            {
                ...
                if (this.mc.thePlayer.experienceLevel < var15 && !this.mc.thePlayer.capabilities.isCreativeMode)
                {
					...
					if(this.containerEnchantment.effectId == 0)
					{
						this.drawTexturedModalRect(var5 + 8, var6 + 43, 108 + 96, 174, 24, 24);
					}
					else if(this.containerEnchantment.effectId == EnumMagicEffect.flame.getEffectId())
					{
						this.drawTexturedModalRect(var5 + 8, var6 + 43, 108, 174, 24, 24);
						this.drawTexturedModalRect(var5 + 145, var6 + 9 + 14 + 19 * var13, 108, 166, 8, 8);
					}
					else if(this.containerEnchantment.effectId == EnumMagicEffect.freeze.getEffectId())
					{
						this.drawTexturedModalRect(var5 + 8, var6 + 43, 108 + 24, 174, 24, 24);
						this.drawTexturedModalRect(var5 + 145, var6 + 9 + 14 + 19 * var13, 108 + 8, 166, 8, 8);
					}
					else if(this.containerEnchantment.effectId == EnumMagicEffect.lifesteal.getEffectId())
					{
						this.drawTexturedModalRect(var5 + 8, var6 + 43, 108 + 48, 174, 24, 24);
						this.drawTexturedModalRect(var5 + 145, var6 + 9 + 14 + 19 * var13, 108 + 16, 166, 8, 8);
					}
					else if(this.containerEnchantment.effectId == EnumMagicEffect.flee.getEffectId())
					{
						this.drawTexturedModalRect(var5 + 8, var6 + 43, 108 + 72, 174, 24, 24);
						this.drawTexturedModalRect(var5 + 145, var6 + 9 + 14 + 19 * var13, 108 + 24, 166, 8, 8);
					}

...
public class EntityAISpitAttack extends EntityAIBase
{
    World worldObj;
    ...
    public EntityAISpitAttack(EntityLiving par1EntityLiving, float par2, int par3, int par4)
    {
    ...
    {
		EntitySpitball var9 = new EntitySpitball(this.worldObj, this.entityHost);

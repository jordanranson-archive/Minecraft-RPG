...
public class EntityMagicRodProjectile extends Entity
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntityMagicRodProjectile(World par1World, EntityLiving par2EntityLiving, EntityLiving par3EntityLiving, float par4, float par5)
    {
        super(par1World);
        ...
        if (var12 >= 1.0E-7D)
        {
            ...
            this.setProjectileHeading(var6, var8 + (double)var20, var10, par4, par5);
        }
    }

    public EntityMagicRodProjectile(World par1World, EntityLiving par2EntityLiving, float par3, int par4)
    {
        super(par1World);
        this.shootingEntity = par2EntityLiving;
		this.magicRodMaterial = par4;
        ...
        this.setProjectileHeading(this.motionX, this.motionY, this.motionZ, par3 * 1.5F, 1.0F);
    }
     ...
     */
    public void setProjectileHeading(double par1, double par3, double par5, float par7, float par8)
    {
        ...
        else
        {
            ...
            if (var4 != null)
            {
                if (var4.entityHit != null)
                {
					...
					if (this.isFrozen() && var4.entityHit instanceof EntityLiving)
					{
						EntityLiving entityHit = (EntityLiving)var4.entityHit;
						entityHit.addPotionEffect(new PotionEffect(2, 142, 0));
					}
    ...
    public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        par1NBTTagCompound.setByte("shake", (byte)this.projectileShake);
        par1NBTTagCompound.setByte("inGround", (byte)(this.inGround ? 1 : 0));
        par1NBTTagCompound.setByte("pickup", (byte)this.canBePickedUp);
        par1NBTTagCompound.setDouble("damage", this.damage);
        par1NBTTagCompound.setInteger("magicRodMaterial", this.magicRodMaterial);
    }
    ...
    public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        this.projectileShake = par1NBTTagCompound.getByte("shake") & 255;
        this.inGround = par1NBTTagCompound.getByte("inGround") == 1;
        this.magicRodMaterial = par1NBTTagCompound.getInteger("magicRodMaterial");
	...
	public void setFrozen(boolean isFrozen)
	{
		...
		byte var2 = this.dataWatcher.getWatchableObjectByte(15);
        if (isFrozen)
        {
            this.dataWatcher.updateObject(15, Byte.valueOf((byte)(var2 | 1)));
        }
        else
        {
            this.dataWatcher.updateObject(15, Byte.valueOf((byte)(var2 & -2)));
        }
	}
	
	public boolean animateFrozen()
    {
        byte var1 = this.dataWatcher.getWatchableObjectByte(15);
        return (var1 & 1) != 0;
    }

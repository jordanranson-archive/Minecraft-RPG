...
public class EntityPlayerMP extends EntityPlayer implements ICrafting
{
    ...
    {
        this.incrementWindowID();
        this.playerNetServerHandler.sendPacketToPlayer(new Packet100OpenWindow(this.currentWindowId, 7, "Prospecting", 9));
        this.craftingInventory = new ContainerProspecting(this.inventory, this.worldObj, par1, par2, par3);
        this.craftingInventory.windowId = this.currentWindowId;
        this.craftingInventory.addCraftingToCrafters(this);
    }

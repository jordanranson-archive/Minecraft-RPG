...
public class Block
{
	...
	// avenphire added code
	public static final BlockFlower plantPurple = (BlockFlower)(new BlockFlower(256, 184)).setHardness(0.0F).setStepSound(soundGrassFootstep).setLightValue(0.65F).setBlockName("purpleFlower");

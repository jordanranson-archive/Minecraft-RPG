...
public class WorldManager implements IWorldAccess
{
    ...
    {
        this.mcServer.getConfigurationManager().sendPacketToPlayersAroundPoint(par2, par4, par6, par8 > 1.0F ? (double)(16.0F * par8) : 16.0D, this.theWorldServer.provider.worldType, new Packet62LevelSound(par1Str, par2, par4, par6, par8, par9));
    }
    ...
    {
        this.mcServer.getConfigurationManager().sendToAllNearExcept(par1EntityPlayer, (double)par3, (double)par4, (double)par5, 64.0D, this.theWorldServer.provider.worldType, new Packet61DoorChange(par2, par3, par4, par5, par6));
    }
